    ...
    public partial class seedingData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<DateTime>(
                ...
                table: "Orders",
                nullable: false,
                defaultValue: new DateTime(2022, 3, 11, 15, 21, 27, 417, DateTimeKind.Local).AddTicks(3674),
                oldClrType: typeof(DateTime),
                oldType: "datetime2",
                oldDefaultValue: new DateTime(2022, 3, 11, 14, 55, 50, 485, DateTimeKind.Local).AddTicks(3066));
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CreatedDate", "Name", "OriginalPrice", "Price", "SeoAlias" },
                values: new object[] { 1, new DateTime(2022, 3, 11, 15, 21, 27, 428, DateTimeKind.Local).AddTicks(3314), null, 100000m, 200000m, null });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "datetime2",
                nullable: false,
                defaultValue: new DateTime(2022, 3, 11, 14, 55, 50, 485, DateTimeKind.Local).AddTicks(3066),
                oldClrType: typeof(DateTime),
                oldDefaultValue: new DateTime(2022, 3, 11, 15, 21, 27, 417, DateTimeKind.Local).AddTicks(3674));
        }
    }
}
